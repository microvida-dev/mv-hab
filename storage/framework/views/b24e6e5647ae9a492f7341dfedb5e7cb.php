...
<svg <?php echo e($attributes->merge(['class' => 'h-5 w-5'])); ?> viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <path d="<?php echo e($paths[$name] ?? $paths['dashboard']); ?>" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
</svg>
<?php /**PATH /Users/brunocorreia/Documents/CRM HAB/MV-HAB/resources/views/components/ui-icon.blade.php ENDPATH**/ ?>