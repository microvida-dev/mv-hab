    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            <form method="GET" class="grid gap-4 border-y border-ink-100 py-5 sm:grid-cols-2 lg:grid-cols-5">
                <input type="search" name="number" value="{{ request('number') }}" placeholder="Número" class="rounded-2xl border-ink-300 text-sm">
                            ...
                            @forelse ($applications as $application)
                                <tr>
                                    ...
                                    <td class="px-5 py-4 text-right">
                                        <a href="{{ route('backoffice.cases.applications.show', $application) }}" class="font-semibold text-mvhab-primary">Abrir processo</a>
