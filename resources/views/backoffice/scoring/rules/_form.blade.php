...
<form method="POST" action="{{ $action }}" class="space-y-6">
    ...
    <div>
        ...
        <textarea id="description" name="description" rows="3" class="mv-input mt-1 block w-full">{{ old('description', $rule->description) }}</textarea>
    </div>
    ...
    <div class="flex flex-wrap gap-3">
        ...
        <a href="{{ route('backoffice.scoring.rules.index', $criterion) }}" class="mv-button-secondary">Cancelar</a>
    </div>
</form>
