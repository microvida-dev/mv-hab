<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div><p class="text-sm font-semibold text-mvhab-primary">Classificação</p><h1 class="mt-1 text-2xl font-semibold text-ink-900">Execuções</h1></div>
            @can('create', \App\Models\ScoringRun::class)
                <a href="{{ route('backoffice.scoring.runs.create') }}" class="mv-button-primary">Executar classificação</a>
            @endcan
        </div>
    </x-slot>
    <div class="py-8"><div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div class="mv-surface overflow-hidden">
