<x-app-layout>
    <x-slot name="header">
        <div class="flex items-end justify-between gap-4">
            <div><p class="text-sm font-semibold text-mvhab-primary">Comunicações</p><h1 class="mt-1 text-2xl font-semibold text-ink-900">Modelos</h1></div>
