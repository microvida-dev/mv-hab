<x-app-layout>
    ...
    <div class="py-8"><div class="mx-auto max-w-4xl space-y-5 px-4 sm:px-6 lg:px-8">
        <div class="rounded-md border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">Pré-visualização com dados fictícios. Templates oficiais exigem validação municipal e jurídica.</div>
