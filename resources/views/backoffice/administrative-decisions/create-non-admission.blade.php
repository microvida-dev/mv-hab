<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-semibold text-ink-900">Propor não admissão</h1>
        </div>
    </x-slot>

    <div class="py-8"><div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('backoffice.administrative-decisions.store-non-admission', $process) }}" class="mv-surface space-y-4 p-6">
            @csrf
