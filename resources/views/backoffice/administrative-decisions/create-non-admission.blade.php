<x-app-layout>
    <x-slot name="header">
        <x-mv.page-header
            ...
            title="Propor não admissão"
            description="Registe a proposta de não admissão com fundamentação obrigatória."
        />
    </x-slot>

    <div class="py-8">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('backoffice.administrative-decisions.store-non-admission', $process) }}">
                @csrf
                <x-mv.section title="Proposta de não admissão">
