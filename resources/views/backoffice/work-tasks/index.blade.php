<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div>
                <p class="text-sm font-semibold text-civic-700">Caixa de trabalho municipal</p>
    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" class="mv-surface grid gap-4 p-4 md:grid-cols-5">
                ...
                <label class="text-sm font-semibold text-ink-700">
                    Prioridade
                    <select name="priority" class="mt-1 w-full rounded-md border-ink-200 text-sm">
                ...
                <label class="text-sm font-semibold text-ink-700">
                    Tipo
                    <select name="type" class="mt-1 w-full rounded-md border-ink-200 text-sm">
                        <option value="">Todos</option>
                ...
                <label class="text-sm font-semibold text-ink-700">
                    Prazo
                    <select name="due" class="mt-1 w-full rounded-md border-ink-200 text-sm">
                        <option value="">Todos</option>
                    ...
                    <tbody class="divide-y divide-ink-100">
                        @forelse ($tasks as $task)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right"><a class="font-semibold text-civic-700" href="{{ route('backoffice.work-tasks.show', $task) }}">Abrir</a></td>
                            </tr>
                        @empty
