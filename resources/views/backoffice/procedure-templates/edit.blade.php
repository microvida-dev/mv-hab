<x-app-layout>
    <x-slot name="header"><div><p class="text-sm font-semibold text-civic-700">Minuta</p><h1 class="mt-1 text-2xl font-semibold text-ink-900">Editar minuta</h1></div></x-slot>
