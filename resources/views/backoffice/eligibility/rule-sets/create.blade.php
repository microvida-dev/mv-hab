<x-app-layout>
    <x-slot name="header"><div><p class="text-sm font-semibold text-civic-700">Elegibilidade</p><h1 class="mt-1 text-2xl font-semibold text-ink-900">Novo conjunto de regras</h1></div></x-slot>
