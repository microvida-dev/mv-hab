<x-app-layout>
    ...
    <div class="py-8"><div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <p class="rounded-2xl bg-amber-50 p-4 text-sm text-amber-900">Ao publicar esta lista, os candidatos poderão consultar os resultados e, se aplicável, apresentar reclamação dentro do prazo configurado. Confirme que a lista foi revista, aprovada e que a anonimização está correta.</p>
    </div></div>
</x-app-layout>
