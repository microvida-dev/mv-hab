<x-app-layout>
    <x-slot name="header"><div><h1 class="text-xl font-semibold text-ink-900">Dashboard operacional</h1><p class="mt-1 text-sm text-ink-500">Carga de trabalho e alertas correntes.</p></div></x-slot>
    <div class="space-y-6">
