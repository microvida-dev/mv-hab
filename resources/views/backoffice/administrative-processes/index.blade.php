    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" class="grid gap-4 border-y border-ink-100 py-5 sm:grid-cols-2 lg:grid-cols-6">
                <input type="search" name="search" value="{{ request('search') }}" placeholder="Processo ou candidatura" class="rounded-md border-ink-300 text-sm">
                ...
                <select name="assigned_to" class="rounded-md border-ink-300 text-sm">
                        ...
                        <tbody class="divide-y divide-ink-100">
                            @forelse ($processes as $process)
                                <tr>
                                    ...
                                    <td class="px-5 py-4 text-right"><a href="{{ route('backoffice.administrative-processes.show', $process) }}" class="font-semibold text-civic-700">Consultar</a></td>
                                </tr>
                            @empty
