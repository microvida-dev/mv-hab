<x-app-layout>
    <x-slot name="header">
        <x-mv.page-header
            ...
            description="Receção, triagem, aperfeiçoamento e decisão de admissão para classificação."
        >
            <x-slot name="actions">
    ...
    <div class="py-8">
        <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
            ...
            <form method="GET" class="grid gap-4 border-y border-ink-100 py-5 sm:grid-cols-2 lg:grid-cols-6">
                <input type="search" name="search" value="{{ request('search') }}" placeholder="Processo ou candidatura" class="mv-input text-sm">
            ...
            <x-mv.section title="Processos" padding="p-0" class="overflow-hidden">
                        ...
                        <tbody class="divide-y divide-ink-100">
                            @forelse ($processes as $process)
                                <tr>
                                    ...
                                    <td class="px-5 py-4"><x-mv.badge>{{ $process->status->label() }}</x-mv.badge></td>
