...
<a
    href="{{ $result['url'] }}"
    class="block rounded-md border border-ink-100 bg-white px-4 py-3 transition hover:border-civic-300 hover:bg-civic-50 focus:outline-none focus:ring-2 focus:ring-civic-600 focus:ring-offset-2"
>
