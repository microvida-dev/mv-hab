...
<a
    href="{{ $result['url'] }}"
    class="block rounded-2xl border border-ink-100 bg-mvhab-card px-4 py-3 transition hover:border-mvhab-support hover:bg-mvhab-surface focus:outline-none focus:ring-2 focus:ring-mvhab-primary focus:ring-offset-2"
>
