...
<section id="case-tab-timeline" class="mv-card">
    <div class="border-b border-ink-100 px-5 py-4">
        <x-ui.section-header title="Cronologia agregada" description="Eventos autorizados do caso, sem payload sensível." />
    </div>
    ...
    <div class="divide-y divide-ink-100">
        ...
        @empty
            <div class="p-5">
                <x-cases.enterprise.empty-state title="Sem eventos" description="Ainda não existem eventos autorizados para este caso." />
            </div>
        @endforelse
    </div>
</section>
