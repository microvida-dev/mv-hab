...
<section class="mv-card p-5">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
            <p class="text-sm font-semibold text-civic-700">Espaço de Trabalho Enterprise</p>
            ...
            <div class="mt-3 flex flex-wrap gap-2">
                ...
                <x-ui.status-badge status="info" :label="$summary['sla']" />
            </div>
        </div>

        <div class="rounded-lg border border-ink-100 bg-ink-50 px-4 py-3 text-sm">
