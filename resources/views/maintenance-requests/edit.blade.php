<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-ink-900">Editar pedido de manutenção</h2>
    </x-slot>
            ...
            <div class="mv-surface p-6">
                <form method="POST" action="{{ route('maintenance-requests.update', $maintenanceRequest) }}" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3">
                        <a href="{{ route('maintenance-requests.show', $maintenanceRequest) }}" class="mv-button-secondary">
                            Cancelar
                        </a>
