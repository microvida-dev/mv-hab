<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-semibold text-ink-900">Editar membro</h1>
        </div>
    </x-slot>

    <div class="py-8">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('candidate.household-members.update', $member) }}" class="mv-surface p-6">
                @csrf
                @method('PUT')
