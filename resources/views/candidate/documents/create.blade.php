    ...
    <div class="py-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            ...
            <x-mv.section
                ...
                description="Submeta apenas documentos legíveis e correspondentes ao tipo solicitado."
            >
                <form method="POST" action="{{ route('candidate.documents.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-ink-500">
                            Formatos permitidos: PDF, JPG, PNG ou WEBP. Tamanho máximo: {{ $item['document_type']->max_file_size_mb }} MB.
                        </p>
