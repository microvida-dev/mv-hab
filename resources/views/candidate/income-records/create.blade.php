<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-semibold text-ink-900">Adicionar rendimento</h1>
        </div>
    </x-slot>

    <div class="py-8">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('candidate.income-records.store') }}" class="mv-surface p-6">
                @csrf
                ...
                <div class="mt-8 flex flex-wrap justify-end gap-3 border-t border-ink-100 pt-6">
                    ...
                    <button type="submit" class="mv-button-primary">Guardar rendimento</button>
                </div>
            </form>
        </div>
    </div>
