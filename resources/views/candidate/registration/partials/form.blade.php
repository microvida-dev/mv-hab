...
<div class="space-y-8">
    ...
    <section class="border-t border-ink-100 pt-7">
        ...
        <div class="mt-4 grid gap-3">
            <x-mv.checkbox-card
                name="accepts_terms"
                label="Declaro que li e aceito os termos de utilização. *"
                :checked="old('accepts_terms', $registration?->accepts_terms ?? false)"
                align="start"
            />
            ...
            <x-mv.checkbox-card
                ...
                label="Confirmo a informação sobre o tratamento dos meus dados para gestão do Registo de Adesão e futuras candidaturas. *"
                :checked="old('accepts_data_processing', $registration?->accepts_data_processing ?? false)"
                align="start"
            />
