...
class ContractsPermissionRoutesTest extends TestCase
{
     ...
     */
    public function test_sprint_47e_manifest_routes_are_permission_first(): void
    {
        $manifest = json_decode(
            (string) file_get_contents(
                base_path('docs/access/manifests/sprint-47e-route-manifest.json'),
            ),
            true,
        ...
        $this->assertCount(58, $definitions);
        ...
        $this->assertCount(58, array_unique($routeNames));
    }
}
