...
class EligibilityScoringPermissionRoutesTest extends TestCase
{
     ...
     */
    public function test_sprint_47c_manifest_routes_are_permission_first(): void
    {
        $manifest = json_decode(
            (string) file_get_contents(
                base_path('docs/access/manifests/sprint-47c-route-manifest.json'),
            ),
            true,
        ...
        $this->assertSame(33, $routesWithFeature);
    }
}
