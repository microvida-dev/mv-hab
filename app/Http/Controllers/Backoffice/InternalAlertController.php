...
class InternalAlertController extends Controller
{
    ...
    {
        Gate::authorize('viewAnyBackoffice', InternalAlert::class);
        $alerts = $this->municipalScope
            ->internalAlerts(InternalAlert::query(), $this->currentUser())
            ->latest()
            ->paginate(20);
    ...
    {
        Gate::authorize('viewBackoffice', $internalAlert);
    ...
    {
        Gate::authorize('detectBackoffice', InternalAlert::class);
    ...
    {
        Gate::authorize('resolveBackoffice', $internalAlert);
    ...
    {
        Gate::authorize('dismissBackoffice', $internalAlert);
