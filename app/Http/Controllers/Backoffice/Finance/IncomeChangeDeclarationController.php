...
class IncomeChangeDeclarationController extends Controller
{
    public function __construct(
        private readonly IncomeChangeService $service,
        private readonly MunicipalRecordScopeService $municipalScope,
    ) {}

    public function index(): View
    {
        Gate::authorize('viewAnyBackoffice', IncomeChangeDeclaration::class);
        $declarations = $this->municipalScope
            ->incomeChangeDeclarations(IncomeChangeDeclaration::query(), $this->currentUser())
            ->with(['tenant', 'tenantFinancialAccount', 'rentReview'])
            ->latest()
            ->paginate(25);
    ...
    {
        Gate::authorize('viewBackoffice', $incomeChangeDeclaration);
    ...
    {
        Gate::authorize('approveBackoffice', $incomeChangeDeclaration);
    ...
    {
        Gate::authorize('rejectBackoffice', $incomeChangeDeclaration);
