...
class CorrectionResponseReviewController extends Controller
{
    ...
    public function show(Request $request, CorrectionResponse $correctionResponse): View
    {
        Gate::authorize('viewBackoffice', $correctionResponse);
    ...
    {
        Gate::authorize('decideBackoffice', $correctionResponse);
