...
Esta sprint pertence à fase de melhoria da experiência do candidato durante a candidatura, com foco em visitas, comunicação assistida, suporte, rastreabilidade e redução de inconsistências entre simulação e candidatura.

A Sprint 22 deve evoluir a plataforma municipal de Habitação/Arrendamento Acessível para permitir que o candidato, após iniciar ou submeter candidatura, tenha apoio estruturado, possa agendar visitas a imóveis quando aplicável, comunicar com os serviços municipais através de tickets e acompanhar todo o histórico de interações.

Esta sprint deve preservar os fluxos já existentes de:
...
Melhorar significativamente a experiência do utilizador durante a candidatura.
...
```text
Consulte imóveis visitáveis associados à candidatura ou concurso
Solicite/agende visita
Reagende visita dentro das regras definidas
Cancele visita dentro das regras definidas
Veja calendário de visitas próprias
Receba notificações sobre visitas
Abra tickets de apoio
Responda a conversas com técnicos
Consulte histórico completo de interações
Veja FAQ contextual durante a candidatura
Receba alertas quando dados da candidatura divergem da simulação
```

A plataforma deve permitir que o Município:

```text
Configure disponibilidade para visitas
Configure janelas horárias
Configure capacidade máxima por visita
Aprove, recuse, reagende ou cancele visitas
Acompanhe calendário de visitas
Atribua técnicos a visitas
Faça gestão de tickets
Responda a candidatos por conversa interna
Classifique pedidos de apoio
Consulte histórico processual de interações
Identifique inconsistências entre simulação e candidatura
Reduza contactos dispersos por e-mail/telefone
Mantenha auditoria e rastreabilidade
```
...
Executa apenas esta Sprint 22.

Não avances para Sprint 23 ou qualquer sprint futura sem validação explícita.
...
Não criar integração externa obrigatória com Google Calendar, Outlook, SMS, WhatsApp, chatbot, Zendesk, Freshdesk ou outro serviço externo.
...
## 9.7 Inconsistência entre simulador e candidatura
...
## 11.4 HousingVisitStatusHistory
...
## 11.11 ApplicationSimulationInconsistency
...
## 13.2 VisitSlotGenerationService
...
## 13.8 SupportTicketMessageService
...
## 13.10 ApplicationSimulationConsistencyService
...
## 13.11 CandidateInteractionService
...
## 20.1 Área de visitas do candidato
...
## 20.3 Área de apoio do candidato
...
# 21. Regras de calendário e disponibilidade
...
# 22. Regras de tickets e conversação
...
# 23. Indicadores de inconsistência entre simulador e candidatura
...
# 27. Backoffice — indicadores mínimos
...
## 29.4 Testes de inconsistências
...
# 30. PHPStan específico da Sprint 22
