# MASTER PROMPT — EXECUÇÃO DA SPRINT 18: RGPD, SEGURANÇA E AUDITORIA AVANÇADA

Atua como arquiteto sénior Laravel, tech lead, security engineer e product engineer especializado em plataformas públicas com dados sensíveis.
...
Esta sprint pertence à fase de preparação da plataforma municipal de Arrendamento Acessível para operação real com dados sensíveis, auditoria externa, rastreabilidade administrativa, controlo RGPD, reforço de autenticação e segurança pré-produção.

A Sprint 18 deve reforçar permissões, autenticação multifator, logs de acesso, auditoria completa, consentimentos, retenção documental, anonimização, exportação de dados do titular, pedidos RGPD, encriptação seletiva, alertas de segurança, armazenamento privado, backups, políticas de password e checklist de conformidade pré-produção.

---

# 1. Regra principal

Executa apenas a Sprint 18.
...
Se este ficheiro não existir, interrompe e informa que falta o ficheiro de definição da Sprint 18.
...
Implementar RGPD, segurança e auditoria avançada.
...
# 10. Fluxos funcionais obrigatórios

## 10.1 Fluxo de auditoria
...
## 10.3 Fluxo de retenção documental
...
# 11. Ações críticas obrigatórias a auditar
...
## 13.13 DataSubjectRequestAction
...
## PreProductionSecurityChecklistService
...
## DPO / perfil de privacidade, se existir
...
# 24. Regras de encriptação de campos sensíveis
...
# 26. Regras de retenção documental
...
# 27. Regras de alertas de segurança
...
# 28. Revisão de armazenamento privado
...
# 30. Integração com notificações — Sprint 16
...
# 31. Integração com relatórios — Sprint 17
...
Fim da master prompt da Sprint 18.
