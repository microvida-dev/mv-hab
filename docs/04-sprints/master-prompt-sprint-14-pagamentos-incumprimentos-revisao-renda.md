# MASTER PROMPT — EXECUÇÃO DA SPRINT 14: PAGAMENTOS, INCUMPRIMENTOS E REVISÃO DE RENDA
...
A Sprint 14 deve completar a gestão financeira operacional após a ativação do contrato: conta corrente, plano mensal de rendas, pagamentos, recibos internos, incumprimentos, acordos de regularização, revisão de renda, alteração de rendimentos e atualização documental anual.

---

# 1. Regra principal

Executa apenas a Sprint 14.
...
Se este ficheiro não existir, interrompe e informa que falta o ficheiro de definição da Sprint 14.
...
Não apagar histórico financeiro existente.
...
Não ativar contratos nesta sprint.

Não recalcular contrato inicial nesta sprint, salvo revisão formal de renda.

---

# 6. Validação jurídica, financeira e fiscal obrigatória

Esta sprint tem impacto financeiro, jurídico e potencialmente fiscal.
...
Reversões de pagamento devem exigir motivo.
Saldos devem ser recalculáveis a partir de movimentos financeiros.
```
...
```text
Crie conta corrente por contrato ativo
Crie plano mensal de rendas
Gere prestações mensais de renda
Registe pagamentos
Associe pagamentos a prestações
Importe pagamentos manualmente ou por ficheiro simples
...
Aplique nova renda com data de eficácia
...
## 12.13 RegularizationInstallment
...
## 12.16 AnnualDocumentUpdateRequest
...
## 12.17 AnnualDocumentUpdateSubmission
...
## RegularizationAgreementService
...
# 23. Regras de plano mensal de rendas
...
# 24. Regras de pagamento e conciliação
...
# 25. Regras de atrasos e incumprimento
...
# 26. Regras de acordos de regularização
...
# 29. Integração com contrato — Sprint 13
...
# 30. Integração com notificações
...
Fim da master prompt da Sprint 14.
